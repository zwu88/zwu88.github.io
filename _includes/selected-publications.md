...
<div class="row pub-row"> 
  ...
  <div class="col-sm-7" style="position: relative;padding-right: 20px;padding-left: 15px;">
      {% if link.summary %}
  ...
  <div class="col-sm-5 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    {% if link.image %} 
    <img src="{{ link.image }}" class="teaser img-fluid z-depth-1" style="width:auto; height:70%;">
